...
public class Ghost extends MovingObject {
   ...
   // private final PacMan pacMan;
    ...
    private static final Image HOLLOW_IMAGE1 = new Image(Ghost.class.getResourceAsStream("ghosthollow2.png"));
    private static final Image HOLLOW_IMAGE2 = new Image(Ghost.class.getResourceAsStream("ghosthollow3.png"));
    private static final Image HOLLOW_IMAGE3 = new Image(Ghost.class.getResourceAsStream("ghosthollow1.png"));
    ...
    public Ghost(Image defaultImage1, Image defaultImage2, Maze maze/*, PacMan pacMan*/, int x, int y, int xDirection, int yDirection, int trapTime) {
        ...
        imageY = new SimpleIntegerProperty((int)MazeData.calcGridY(y));
    ...
    private void moveVerticallyInCage() {
        ...
        if (moveCounter > ANIMATION_STEP - 1) {
            moveCounter = 0;
            y += yDirection;
            imageY.set((int)MazeData.calcGridX(y) + 8);
